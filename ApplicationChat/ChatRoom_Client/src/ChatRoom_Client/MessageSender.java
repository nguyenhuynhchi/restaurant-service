...
//                        sendFile(selectedFile); // Gửi file thông thường
    ...
    public void sendGroupInfo() {
        try {
            ...
            selectedClients.add(clientID + "|" + fullName); // Thêm client tạo nhóm
            ...
            } else if (selectedClients.size() <= 2 || selectedClients.isEmpty()) { // Chưa chọn đủ client 
                JOptionPane.showMessageDialog(null, "Thành viên trong nhóm phải từ 2 người trở lên", "Thông báo", JOptionPane.ERROR_MESSAGE);
            } else {
